...
本文档参考：<https://www.liaoxuefeng.com/wiki/896043488029600>

也可阅读：  
[Git 完整命令手册（在线）](http://git-scm.com/docs)  
[Git 完整命令手册（PDF版）](github-git-cheat-sheet.pdf)  
[Git 菜鸟教程runoob.com](https://www.runoob.com/git/git-tutorial.html)  
